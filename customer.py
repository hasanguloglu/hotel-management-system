...
class Custom_Window:
    def __init__(self, root):
        ...
        self.root.geometry("1020x500+255+150")
        ...
        entry_ref = ttk.Entry(label_frame_left, width=10, font=("TkDefaultFont", 10, "bold"))
        ...
        entry_customer_name = ttk.Entry(label_frame_left, width=10, font=("TkDefaultFont", 10, "bold"))
        ...
        entry_mother_name = ttk.Entry(label_frame_left, width=10, font=("TkDefaultFont", 10, "bold"))
        ...
        combo_gender = ttk.Combobox(label_frame_left, font=("TkDefaultFont", 10, "bold"), width=8, state="readonly")
        ...
        entry_postcode = ttk.Entry(label_frame_left, width=10, font=("TkDefaultFont", 10, "bold"))
        ...
        entry_mobile = ttk.Entry(label_frame_left, width=10, font=("TkDefaultFont", 10, "bold"))
        ...
        entry_email = ttk.Entry(label_frame_left, width=10, font=("TkDefaultFont", 10, "bold"))
        ...
        combo_nationality = ttk.Combobox(label_frame_left, font=("TkDefaultFont", 10, "bold"), width=8, state="readonly")
        ...
        combo_id_proof = ttk.Combobox(label_frame_left, font=("TkDefaultFont", 10, "bold"), width=8, state="readonly")
        ...
        entry_id_number = ttk.Entry(label_frame_left, width=10, font=("TkDefaultFont", 10, "bold"))
        ...
        entry_adress = ttk.Entry(label_frame_left, width=10, font=("TkDefaultFont", 10, "bold"))
        ...
        table_frame.place(x=255, y=50, width=860, height=450)
        ...
        self.customer_details_table = ttk.Treeview(details_table, column=("Ref", "Name", "Mother", "Gender", "Postcode", "Mobile", "Email", "Nationality", "Id Proof", "Id Number", "Address"), xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set,)
        ...
        self.customer_details_table.column("Id Proof", width=100)
        self.customer_details_table.column("Id Number", width=100)
